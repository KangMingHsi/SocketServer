...
namespace GameNetwork
{
	...
	internal static class RSAHelper
	{
		...
		public static string Encrypt(string publicKey, string content)
		{
			...
			var encryptString = Convert.ToBase64String(rsa.Encrypt(System.Text.Encoding.UTF8.GetBytes(content), false));
		...
		public static string Decrypt(string privateKey, string encryptedContent)
		{
			...
			var decryptString = System.Text.Encoding.UTF8.GetString(rsa.Decrypt(Convert.FromBase64String(encryptedContent), false));
